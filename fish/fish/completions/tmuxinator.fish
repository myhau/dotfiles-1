...
complete -f -c mux -a '(tmuxinator completions start)'
complete -f -c mux -a '(tmuxinator commands)'
complete -f -c mux -n '__fish_tmuxinator_using_command start' -a '(tmuxinator completions start)'
complete -f -c mux -n '__fish_tmuxinator_using_command open' -a '(tmuxinator completions open)'
complete -f -c mux -n '__fish_tmuxinator_using_command copy' -a '(tmuxinator completions copy)'
complete -f -c mux -n '__fish_tmuxinator_using_command delete' -a '(tmuxinator completions delete)'
